...
i=t!=t?1:0,n=s):(n=k(P(t)/L),t*(o=_(2,-n))<1&&(n--,o*=2),n+f>=1?t+=c/o:t+=c*_(2,1-f),t*o>=2&&(n++,o/=2),n+f>=s?(i=0,n=s):n+f>=1?(i=(t*o-1)*_(2,e),n+=f):(i=t*_(2,f-1)*_(2,e),n=0));e>=8;a[l++]=255&i,i/=256,e-=8);for(n=n<<e|i,u+=e;u>0;a[l++]=255&n,n/=256,u-=8);return a[--l]|=128*h,a}function D(t,e,r){var n,i=8*r-e-1,o=(1<<i)-1,a=o>>1,u=i-7,s=r-1,f=t[s--],c=127&f;for(f>>=7;u>0;c=256*c+t[s],s--,u-=8);for(n=c&(1<<-u)-1,c>>=-u,u+=e;u>0;n=256*n+t[s],s--,u-=8);if(0===c)c=1-a;else{if(c===o)return n?NaN:f?-1/0:1/0;n+=_(2,e),c-=a}return(f?-1:1)*n*_(2,c-e)}function C(t){return t[3]<<24|t[2]<<16|t[1]<<8|t[0]}function G(t){return[255&t]}function V(t){return[255&t,t>>8&255]}function q(t){return[255&t,t>>8&255,t>>16&255,t>>24&255]}function W(t){return M(t,52,8)}function J(t){return M(t,23,4)}function Y(t,e,r){d(t[b],e,{get:function(){return this[r]}})}function H(t,e,r,n){var i=h(+r);if(i+e>t[I])throw O(E);var o=t[N]._b,a=i+t[B],u=o.slice(a,a+e);return n?u:u.reverse()}function Z(t,e,r,n,i,o){var a=h(+r);if(a+e>t[I])throw O(E);for(var u=t[N]._b,s=a+t[B],f=n(+i),c=0;c<e;c++)u[s+c]=f[o?c:e-c-1]}if(o.ABV){if(!s(function(){S(1)})||!s(function(){new S(-1);// eslint-disable-line no-new
...
(f(t,v,c),E(r))?r instanceof X||(o=b(r))==Y||o==H?void 0!==i?new y(r,tk(n,e),i):void 0!==n?new y(r,tk(n,e)):new y(r):tx in r?tF(v,r):tN.call(v,r):new y(g(r)))}),Q(m!==Function.prototype?T(y).concat(T(m)):T(y),function(t){t in v||l(v,t,y[t])}),v[z]=x,r||(x.constructor=v));var P=x[tm],L=!!P&&("values"==P.name||void 0==P.name),j=tV.values;l(v,tw,!0),l(x,tx,c),l(x,tR,!0),l(x,tE,v),(s?new v(1)[tb]==c:tb in x)||G(x,tb,{get:function(){return c}}),S[c]=v,o(o.G+o.W+o.F*(v!=y),S),o(o.S,c,{BYTES_PER_ELEMENT:e}),o(o.S+o.F*i(function(){y.of.call(v,1)}),c,{from:tN,of:tI}),Z in x||l(x,Z,e),o(o.P,c,tD),I(c),o(o.P+o.F*t_,c,{set:tG}),o(o.P+!L*o.F,c,tV),r||x.toString==tv||(x.toString=tv),o(o.P+o.F*i(function(){new v(1).slice()}),c,{slice:tC}),o(o.P+o.F*(i(function(){return[1,2].toLocaleString()!=new v([1,2]).toLocaleString()})||!i(function(){x.toLocaleString.call([1,2])})),c,{toLocaleString:tM}),U[c]=L?P:j,r||L||l(x,tm,j)}}else t.exports=function(){}}),E("dRJbK",function(t,e){// all object keys, includes non-enumerable and symbols
...
return"[null]"!=tr([t])||"{}"!=tr({a:t})||"{}"!=tr(Object(t))})),"JSON",{stringify:function(t){for(var e,r,n=[t],i=1;arguments.length>i;)n.push(arguments[i++]);if(r=e=n[1],!(!V(e)&&void 0===t||tv(t)))return C(e)||(e=function(t,e){if("function"==typeof r&&(e=r.call(this,t,e)),!tv(e))return e}),n[1]=e,tr.apply(te,n);// IE8 returns string on undefined
...
tM in tI||w("kLGkJ")&&tN(tI,tM,{configurable:!0,get:function(){try{return(""+this).match(tB)[1]}catch(t){return""}}});var V=w("5epbW"),tk=w("hGDaq"),tD=w("iv1sY")("hasInstance"),tC=Function.prototype;tD in tC||w("l3ykp").f(tC,tD,{value:function(t){if("function"!=typeof this||!V(t))return!1;if(!V(this.prototype))return t instanceof this;// for environment w/o native `@@hasInstance` logic enough `instanceof`, but add this:
...
return rL[F("match")]=!1,rA(rP)!=rP||rA(rL)==rL||"/a/i"!=rA(rP,"i")}))){rA=function(t,e){var r=this instanceof rA,n=eD(t),i=void 0===e;return!r&&n&&t.constructor===rA&&i?t:tX(rj?new r_(n&&!i?t.source:t,e):r_((n=t instanceof rA)?t.source:t,n&&i?rT.call(t):e),r?this:rk,rA)};for(var rF=function(t){(t in rA)||rR(rA,t,{configurable:!0,get:function(){return r_[t]},set:function(e){r_[t]=e}})},rU=rO(r_),rN=0;rU.length>rN;)rF(rU[rN++]);rk.constructor=rA,rA.prototype=rk,w("lsTRt")(S,"RegExp",rA)}w("gqSxK")("RegExp"),w("h2Efn"),w("kLGkJ")&&"g"!=/./g.flags&&w("l3ykp").f(RegExp.prototype,"flags",{configurable:!0,get:w("5Vz3D")});var G=w("kvyZU"),rT=w("5Vz3D"),R=w("kLGkJ"),rI="toString",rB=/./[rI],rM=function(t){w("lsTRt")(RegExp.prototype,rI,t,!0)};w("c69UQ")(function(){return"/a/b"!=rB.call({source:"a",flags:"b"})})?rM(function(){var t=G(this);return"/".concat(t.source,"/","flags"in t?t.flags:!R&&t instanceof RegExp?rT.call(t):void 0)}):rB.name!=rI&&rM(function(){return rB.call(this)});var G=w("kvyZU"),eN=w("hxXsn"),rD={},rC=w("4tMGP")(!0);// `AdvanceStringIndex` abstract operation
// https://tc39.github.io/ecma262/#sec-advancestringindex
rD=function(t,e,r){return e+(r?rC(t,e).length:1)};var rG={},tF=w("c5KT9"),rV=RegExp.prototype.exec;// `RegExpExec` abstract operation
...
function(t,e){var i=n(r,t,this,e);if(i.done)return i.value;var o=G(t),a=String(this),u="function"==typeof e;u||(e=String(e));var s=o.global;if(s){var f=o.unicode;o.lastIndex=0}for(var c=[];;){var l=rG(o,a);if(null===l||(c.push(l),!s))break;""===String(l[0])&&(o.lastIndex=rD(a,eN(o.lastIndex),f))}for(var h="",p=0,d=0;d<c.length;d++){// NOTE: This is equivalent to
...
if(!eD(t))return r.call(a,t,e);for(var u=[],s=(t.ignoreCase?"i":"")+(t.multiline?"m":"")+(t.unicode?"u":"")+(t.sticky?"y":""),f=0,c=void 0===e?4294967295:e>>>0,l=RegExp(t.source,s+"g");(n=rK.call(l,a))&&(!((i=l[r1])>f)||(u.push(a.slice(f,n.index)),n[r0]>1&&n.index<a[r0]&&r$.apply(u,n.slice(1)),o=n[0][r0],f=i,!(u[r0]>=c)));)l[r1]===n.index&&l[r1]++;// Avoid an infinite loop
...
add:function(t){return nE.def(n_(this,"Set"),t=0===t?0:t,t)}},nE);var S=w("4VVRT"),nL=w("a9Nrf")(0),T=w("lsTRt"),A=w("8ZJoP"),nj=w("5bYYj"),nF={},nx=w("6dDiG"),A=w("8ZJoP"),nU=A.getWeak,G=w("kvyZU"),V=w("5epbW"),r5=w("g3IlE"),r4=w("9NO3J"),nN=w("a9Nrf"),x=w("5hs3T"),nI=nN(5),nB=nN(6),nM=0,nD=function(t){return t._l||(t._l=new nC)},nC=function(){this.a=[]},nG=function(t,e){return nI(t.a,function(t){return t[0]===e})};nC.prototype={get:function(t){var e=nG(this,t);if(e)return e[1]},has:function(t){return!!nG(this,t)},set:function(t,e){var r=nG(this,t);r?r[1]=e:this.a.push([t,e])},delete:function(t){var e=nB(this.a,function(e){return e[0]===t});return~e&&this.a.splice(e,1),!!~e}},nF={getConstructor:function(t,e,r,n){var i=t(function(t,o){r5(t,i,e,"_i"),t._t=e,t._i=nM++,t._l=void 0,void 0!=o&&r4(o,r,t[n],t)});return nx(i.prototype,{// 23.3.3.2 WeakMap.prototype.delete(key)
// 23.4.3.3 WeakSet.prototype.delete(value)
delete:function(t){if(!V(t))return!1;var r=nU(t);return!0===r?nD(n_(this,e)).delete(t):r&&x(r,this._i)&&delete r[this._i]},// 23.3.3.4 WeakMap.prototype.has(key)
// 23.4.3.4 WeakSet.prototype.has(value)
has:function(t){if(!V(t))return!1;var r=nU(t);return!0===r?nD(n_(this,e)).has(t):r&&x(r,this._i)}}),i},def:function(t,e,r){var n=nU(G(e),!0);return!0===n?nD(t).set(e,r):n[t._i]=r,t},ufstore:nD};var V=w("5epbW"),nV=!S.ActiveXObject&&"ActiveXObject"in S,nq="WeakMap",nW=A.getWeak,nJ=Object.isExtensible,nY=nF.ufstore,nH=function(t){return function(){return t(this,arguments.length>0?arguments[0]:void 0)}},nZ={// 23.3.3.3 WeakMap.prototype.get(key)
 ...
 */aB=t=>{let e,r,n;let i={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||i[e]&&aI[e]||("set-cookie"===e?i[e]?i[e].push(r):i[e]=[r]:i[e]=i[e]?i[e]+", "+r:r)}),i};let aM=Symbol("internals");function aD(t){return t&&String(t).trim().toLowerCase()}function aC(t){return!1===t||null==t?t:oL.isArray(t)?t.map(aC):String(t)}let aG=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function aV(t,e,r,n,i){if(oL.isFunction(n))return n.call(this,e,r);if(i&&(e=r),oL.isString(e)){if(oL.isString(n))return -1!==e.indexOf(n);if(oL.isRegExp(n))return n.test(e)}}class aq{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function i(t,e,r){let i=aD(e);if(!i)throw Error("header name must be a non-empty string");let o=oL.findKey(n,i);o&&void 0!==n[o]&&!0!==r&&(void 0!==r||!1===n[o])||(n[o||e]=aC(t))}let o=(t,e)=>oL.forEach(t,(t,r)=>i(t,r,e));if(oL.isPlainObject(t)||t instanceof this.constructor)o(t,e);else if(oL.isString(t)&&(t=t.trim())&&!aG(t))o(aB(t),e);else if(oL.isHeaders(t))for(let[e,n]of t.entries())i(n,e,r);else null!=t&&i(e,t,r);return this}get(t,e){if(t=aD(t)){let r=oL.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(oL.isFunction(e))return e.call(this,t,r);if(oL.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=aD(t)){let r=oL.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||aV(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function i(t){if(t=aD(t)){let i=oL.findKey(r,t);i&&(!e||aV(r,r[i],i,e))&&(delete r[i],n=!0)}}return oL.isArray(t)?t.forEach(i):i(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let i=e[r];(!t||aV(this,this[i],i,t,!0))&&(delete this[i],n=!0)}return n}normalize(t){let e=this,r={};return oL.forEach(this,(n,i)=>{let o=oL.findKey(r,i);if(o){e[o]=aC(n),delete e[i];return}let a=t?i.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(i).trim();a!==i&&delete e[i],e[a]=aC(n),r[a]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return oL.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&oL.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[aM]=this[aM]={accessors:{}},r=e.accessors,n=this.prototype;function i(t){let e=aD(t);r[e]||(!function(t,e){let r=oL.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,i){return this[n].call(this,e,t,r,i)},configurable:!0})})}(n,t),r[e]=!0)}return oL.isArray(t)?t.forEach(i):i(t),this}}function aW(t,e){let r=this||aN,n=e||r,i=aq.from(n.headers),o=n.data;return oL.forEach(t,function(t){o=t.call(r,o,i.normalize(),e?e.status:void 0)}),i.normalize(),o}function aJ(t){return!!(t&&t.__CANCEL__)}/**
...
await uH.redirectToCheckout({sessionId:e.data.session.id})}catch(t){console.log(t),uq("error",t)}},uz=document.getElementById("map"),uK=document.querySelector(".form--login"),uX=document.querySelector(".nav__el--logout"),u$=document.querySelector(".form-user-data"),uQ=document.querySelector(".form-user-password"),u0=document.getElementById("book-tour");// const signUpBtn = document.querySelector('.form--signup');
// Delegation
if(uz){let t=JSON.parse(uz.dataset.locations);(t=>{mapboxgl.accessToken="pk.eyJ1Ijoic2hvd21lMDMyIiwiYSI6ImNseThxZ3YybjBneWcycHF3N2V5Ymh6bjgifQ.r9UF4d7C-N92PAKbLG_Lgw";let e=new mapboxgl.Map({container:"map",style:"mapbox://styles/mapbox/light-v11",scrollZoom:!1,center:[t[0].coordinates[0],t[0].coordinates[1]]}),r=new mapboxgl.LngLatBounds;// Create markers for each location in our location
...
e.on("load",()=>{e.fitBounds(r,{padding:{top:100,bottom:80,left:90,right:90},duration:2200})})})(t)}uK&&uK.addEventListener("submit",t=>{t.preventDefault();let e=document.getElementById("email").value,r=document.getElementById("password").value;uW(e,r)}),uX&&uX.addEventListener("click",t=>{uJ()}),u$&&u$.addEventListener("submit",t=>{t.preventDefault();let e=new FormData;e.append("name",document.getElementById("name").value),e.append("email",document.getElementById("email").value),e.append("photo",document.getElementById("photo").files[0]),console.log(e),uY(e,"data")}),uQ&&uQ.addEventListener("submit",async t=>{t.preventDefault();let e=document.getElementById("btn-pass-update");e.textContent="Updating...";let r=document.getElementById("password-current").value,n=document.getElementById("password").value,i=document.getElementById("password-confirm").value;await uY({passwordCurrent:r,password:n,passwordConfirm:i},"password");// clear values, but i like page reloading better
// document.getElementById('password-current').value = ''
// document.getElementById('password').value = ''
// document.getElementById('password-confirm').value = ''
}),u0&&u0.addEventListener("click",t=>{// const tourId = e.target.dataset.tourId;
t.target.textContent="Processing...";let{tourId:e}=t.target.dataset;uZ(e)});// TODO: signup implementation
// if (signUpBtn) {
